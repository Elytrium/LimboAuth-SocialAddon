    ...
    public void init() throws SocialInitializationException {
        try {
            this.jda = JDABuilder
                    ...
                    .disableCache(CacheFlag.ACTIVITY, CacheFlag.VOICE_STATE, CacheFlag.EMOJI, CacheFlag.CLIENT_STATUS, CacheFlag.ONLINE_STATUS, CacheFlag.STICKER, CacheFlag.FORUM_TAGS)
                    .build();
